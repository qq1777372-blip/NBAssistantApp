...
function createSeedData(demoUser = createDemoUser()) {
  ...
  return {
    ...
    expenses: [
      ...
      { id: 303, expense_no: `FY-${compactDate(2)}-003`, expense_date: dateOnly(2), amount: 236, category: '餐饮招待', payment_account: '员工垫付', payment_type: 'employee', expense_scope: '公共费用', description: '供应商沟通工作餐', submitter_name: '陈一凡', reimbursement_status: 'pending', attachment_url: '/favicon.svg', created_at: dateTime(2, 13, 5) },
